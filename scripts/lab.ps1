...
# Browser History
New-Item -Path "HKCU:\Software\Policies\Google\Chrome\AllowDeletingBrowserHistory" -Force | Out-Null
...
# Guest mode
New-Item -Path "HKCU:\Software\Policies\Google\Chrome\BrowserGuestModeEnabled" -Force | Out-Null
New-ItemProperty -Path "HKCU:\Software\Policies\Google\Chrome" `
    -Name "BrowserGuestModeEnabled" -PropertyType DWord -Value 0 -Force

# Browser Signin
New-Item -Path "HKCU:\Software\Policies\Google\Chrome\BrowserSignin" -Force | Out-Null
New-ItemProperty -Path "HKCU:\Software\Policies\Google\Chrome" `
    -Name "BrowserSignin" -PropertyType DWord -Value 0 -Force

# Clear Data on Exit
New-Item -Path "HKCU:\Software\Policies\Google\Chrome\ClearBrowsingDataOnExitList" -Force | Out-Null
New-ItemProperty -Path "HKCU:\Software\Policies\Google\Chrome\ClearBrowsingDataOnExitList" `
